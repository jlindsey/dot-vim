  ...
  if (!exists("g:rails_syntax") || g:rails_syntax)
    ...
    if &syntax == 'ruby'
      ...
      if t =~ '^model$' || t =~ '^model-arb\>'
        ...
        syn keyword rubyRailsARCallbackMethod after_create after_destroy after_initialize before_initialize after_find after_save after_update after_validation after_validation_on_create after_validation_on_update
